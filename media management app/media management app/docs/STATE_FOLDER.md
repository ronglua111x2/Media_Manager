...
Migration `005_cart_recipe_max_candidate_overrides` adds nullable episode/pack/movie Max-candidate overrides for manual Torrent Cart runs. `NULL` preserves the selected recipe value.
