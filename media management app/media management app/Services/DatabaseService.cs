...
public sealed class DatabaseService : IDatabaseService
{
    ...
    public IReadOnlyList<TrackedMovie> GetTrackedMovies()
    {
        ...
        command.CommandText = """
            SELECT Id, TmdbId, Title, ReleaseYear, Overview, PosterPath, RecipeId, PreferredQuality, PreferredAudioCodec,
                   ...
                   SelectedCandidateQuality, SelectedCandidateAudioCodec, AlternativeTitlesJson, ExcludedAlternativeTitlesJson, CreatedUtc, UpdatedUtc
            FROM TrackedMovies
            ORDER BY Title;
            """;
        using var reader = command.ExecuteReader();
    ...
    private static TrackedShow ReadTrackedShow(SqliteDataReader reader)
    {
        return new TrackedShow
        {
            ...
            TotalEpisodes = reader.IsDBNull(35) ? 0 : Convert.ToInt32(reader.GetValue(35)),
            AvailableEpisodes = reader.IsDBNull(36) ? 0 : Convert.ToInt32(reader.GetValue(36))
        };
    }
